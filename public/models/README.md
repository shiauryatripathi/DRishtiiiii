...
- **GitHub Release**: [v1.0.2.5 on GitHub Releases](https://github.com/shiauryatripathi/DRishtiI/releases/tag/v1.0.2.5)
- **Direct Asset Mirror**: [Download from GitHub Release](https://github.com/shiauryatripathi/DRishtiI/releases/download/v1.0.2.5/drishti_resnet50_v1.0.2.5.onnx)
